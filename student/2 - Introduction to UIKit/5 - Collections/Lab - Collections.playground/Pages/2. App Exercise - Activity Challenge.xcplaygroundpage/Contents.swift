 ...
 */
var walkingChallenge = Array<String>()
var runningChallenge = Array<String>()
walkingChallenge.append("Walk 3 miles a day")
runningChallenge.append("Run 5 times a week")
