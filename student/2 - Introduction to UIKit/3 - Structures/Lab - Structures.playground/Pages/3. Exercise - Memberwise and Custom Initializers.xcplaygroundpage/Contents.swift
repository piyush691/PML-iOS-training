...
var somePlace = GPS(lat: 51.514004, lon: 0.125226)
print(somePlace)
...
var favoriteBook = Book(title: "Rich dad poor dad", author: "Robert T. Kiyosaki", pages: 889, price: 1299)
print(favoriteBook)
...
var acer = Laptop(screenSize: 16, repairCount: 2, yearPurchased: 2012)
var mac = Laptop(yearPurchased: 2022)
...
struct Height {
    ...
    var heightInCenti: Double
    init(heightInInches: Double)
    {
        self.heightInInches = heightInInches
        heightInCenti = 2.54 * heightInInches
    }
    init(heightInCenti: Double)
    {
        self.heightInCenti = heightInCenti
        heightInInches = heightInCenti / 2.54
    }
}
...
var mineHeight = Height(heightInCenti: 182)
print(mineHeight)
/*:
